        ...
        <div className="bg-white dark:bg-zinc-900 p-8 rounded-[2.5rem] border border-gray-100 dark:border-zinc-800 shadow-sm">
          ...
          <form action={createPool} className="flex flex-col gap-3">
            <input 
              ...
              required 
            />
            <button className="bg-zinc-900 dark:bg-white text-white dark:text-black py-3 rounded-xl font-black uppercase tracking-widest text-[9px] hover:opacity-90 transition-all">Crear Liga</button>
          </form>
        </div>
        <div className="bg-white dark:bg-zinc-900 p-8 rounded-[2.5rem] border border-gray-100 dark:border-zinc-800 shadow-sm">
