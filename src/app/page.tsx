      ...
      <div className="max-w-5xl mx-auto">
        ...
        {view === 'knockout' && (
          <>
            ...
            <p className="mb-4 flex flex-wrap items-center gap-x-5 gap-y-1.5 text-[8px] font-medium text-zinc-400 dark:text-zinc-500 sm:text-[9px]">
              <span className="inline-flex items-center gap-1.5">
                <span
                  className="inline-flex h-3 w-3 shrink-0 items-center justify-center rounded-full border border-white/80 bg-blue-400 dark:border-zinc-900"
                  aria-hidden
                >
                  <span className="h-0.5 w-0.5 rounded-full bg-white" />
                </span>
                <span className="tracking-tight">Pronóstico</span>
              </span>
              <span className="inline-flex items-center gap-1.5">
                <span
                  className="inline-flex h-3 w-3 shrink-0 items-center justify-center rounded-full border border-white/80 bg-green-500 dark:border-zinc-900"
                  aria-hidden
                >
                  <svg
                ...
                <span className="tracking-tight">Clasificado oficial</span>
              </span>
            </p>
          </>
        )}
