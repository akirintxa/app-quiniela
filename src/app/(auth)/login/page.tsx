    ...
    <div className="min-h-screen bg-gray-50 dark:bg-black flex flex-col justify-center py-12 px-6 lg:px-8 font-sans">
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md text-center">
        ...
        <h2 className="text-4xl font-black text-gray-900 dark:text-white uppercase tracking-tighter">
          FIFA WORLD <span className="text-blue-600">CUP</span>
        </h2>
      ...
      <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-md">
          ...
          <form className="space-y-6">
            ...
            <div>
              <div className="flex justify-between items-center mb-2 ml-1">
                ...
                <Link href="#" className="text-[10px] font-black uppercase tracking-widest text-blue-600 hover:text-blue-500">
                  ¿La olvidaste?
                </Link>
              </div>
            ...
            <div className="flex flex-col gap-3 pt-2">
              ...
              <button
                formAction={signup}
                className="w-full bg-zinc-900 dark:bg-white text-white dark:text-black py-4 rounded-2xl font-black uppercase tracking-widest hover:opacity-90 transition-all active:scale-95"
              >
                Registrarme ahora
              </button>
            </div>
        ...
        <p className="mt-8 text-center text-[10px] font-black text-gray-400 uppercase tracking-widest">
          Juega con responsabilidad • FIFA 2026
        </p>
      </div>
    </div>
  );
